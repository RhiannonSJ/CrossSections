...
void Characterisation ( TH2D *h_smeared, TNtuple *info_s, TNtuple *info_bg ){
    ...
    leg_T_bg->AddEntry( h_Tmu_1pi0_bg, " CC1#pi^{ 0 } ", "f" );
    leg_T_bg->AddEntry( h_Tmu_1pim_bg, " CC1#pi^{ - } ", "f" );
    leg_T_bg->AddEntry( h_Tmu_1pip_bg, " CC1#pi^{ + } ", "f" );
    ...
    leg_T_sbg_split->AddEntry( h_Tmu_nother_bg, " NCOther ", "f" );
    leg_T_sbg_split->AddEntry( h_Tmu_other_bg, " CCOther ", "f" );
    leg_T_sbg_split->AddEntry( h_Tmu_n1cpi_bg, " NC1#pi^{ #pm } ", "f" );
    leg_T_sbg_split->AddEntry( h_Tmu_2cpi_bg, " CC2#pi^{ #pm } ", "f" );
    leg_T_sbg_split->AddEntry( h_Tmu_1pi0_bg, " CC1#pi^{ 0 } ", "f" );
    leg_T_sbg_split->AddEntry( h_Tmu_1pim_bg, " CC1#pi^{ - } ", "f" );
    leg_T_sbg_split->AddEntry( h_Tmu_1pip_bg, " CC1#pi^{ + } ", "f" );
    ...
    leg_cos_bg->AddEntry( h_cosmu_1pi0_bg, " CC1#pi^{ 0 } ", "f" );
    leg_cos_bg->AddEntry( h_cosmu_1pim_bg, " CC1#pi^{ - } ", "f" );
    leg_cos_bg->AddEntry( h_cosmu_1pip_bg, " CC1#pi^{ + } ", "f" );
    ...
    leg_cos_sbg_split->AddEntry( h_cosmu_nother_bg, " NCOther ", "f" );
    leg_cos_sbg_split->AddEntry( h_cosmu_other_bg, " CCOther ", "f" );
    leg_cos_sbg_split->AddEntry( h_cosmu_n1cpi_bg, " NC1#pi^{ #pm } ", "f" );
    leg_cos_sbg_split->AddEntry( h_cosmu_2cpi_bg, " CC2#pi^{ #pm } ", "f" );
    leg_cos_sbg_split->AddEntry( h_cosmu_1pi0_bg, " CC1#pi^{ 0 } ", "f" );
    leg_cos_sbg_split->AddEntry( h_cosmu_1pim_bg, " CC1#pi^{ - } ", "f" );
    leg_cos_sbg_split->AddEntry( h_cosmu_1pip_bg, " CC1#pi^{ + } ", "f" );
